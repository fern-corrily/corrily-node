...
export const ProductIntegration: core.schemas.Schema<
  serializers.ProductIntegration.Raw,
  CorrilyApi.ProductIntegration
> = core.schemas
  .union("type", {
    stripe: core.schemas.lazyObject(async () => (await import("../..")).StripeIntegration),
    stripe_with_interval: core.schemas.lazyObject(async () => (await import("../..")).StripeWithIntervalIntegration),
    chargebee: core.schemas.lazyObject(async () => (await import("../..")).ChargebeeIntegration),
    recurly: core.schemas.lazyObject(async () => (await import("../..")).RecurlyIntegration),
  })
